        ...
        <div class="max-w-7xl mx-auto">
            <div class="mb-8 flex justify-between items-center">
                <div class="inline-flex items-center">
                    <a href="{{ route('student.show', ['course' => $course]) }}">
                        ...
                        @foreach($quizzes as $quizData)
                            ...
                            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300">
                                ...
                                @if(!$exam_taken[$quiz_id])
                                    <div class="mt-4">
                                        <a href="{{route('student.exam', ['courses'=>$course->id, 'quiz'=>$quizData->id]) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition ease-in-out duration-150">
