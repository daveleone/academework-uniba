<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            <h2 class="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">@lang('trad.Student Details')</h2>
            <p class="text-gray-700 dark:text-gray-300"><strong class="text-gray-900 dark:text-white">@lang('trad.Name:')</strong> {{ $student->user->name }}</p>
            <p class="text-gray-700 dark:text-gray-300"><strong class="text-gray-900 dark:text-white">@lang('trad.Email:')</strong> {{ $student->user->email }}</p>
            <p class="text-gray-700 dark:text-gray-300"><strong class="text-gray-900 dark:text-white">@lang('trad.Average Grade:')</strong> {{ number_format($averageGrade, 2, '.', '') }}</p>
