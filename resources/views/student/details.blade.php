<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            <h2 class="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Student Details</h2>
            ...
            <h3 class="text-xl font-semibold mt-6 mb-2 text-gray-900 dark:text-white">Quiz History</h3>
