            ...
            <form action="{{ route('subject.edit') }}" method="post" id="CreateSub" class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="{{ 'subName'.$subject->id }}" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{__("Subject's name")}}</label>
                    ...
                    <div class="col-span-2">
                        <label for="{{ 'subDesc'.$subject->id }}" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{__("Subject's Description")}}</label>
