                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="TopicName" id="TopicName" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md" placeholder="@lang('trad.Type topic\'s name')" required>
                        </div>
                    </div>
                    <div class="col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <textarea id="TopicDescription" name="TopicDescription" rows="4" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md" placeholder="@lang('trad.Write topic\'s description here')" required></textarea>
                        </div>
                    </div>
                </div>
