...
<button data-modal-target="CreateQuiz-modal" data-modal-toggle="CreateQuiz-modal" class="px-3 py-2 text-s font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
    Add quiz <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 pl-1">
...
<!-- Main modal -->
<div id="CreateQuiz-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-gray-900 bg-opacity-50">
            ...
            <form action="{{ route('quiz.create') }}" method="post" id="CreateQuiz" class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="QuizName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quiz name</label>
                    ...
                    <div class="col-span-2">
                        <label for="QuizDescription" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quiz Description</label>
