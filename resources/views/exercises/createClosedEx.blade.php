<x-app-layout>
    ...
    <div class="py-12 flex flex-col items-center w-full">            
        ...
        <div class="ml-10">
            ...
            <button type="submit" form="closed-Form" class="text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" dusk="closed-create-submit">@lang('trad.Submit')</button>
        </div>        
    </div>
