<x-app-layout>
    ...
    <div class="py-12 flex flex-col items-center w-full">            
        <form action="{{ route('exercise.createClosed', ['id' => $topic->id]) }}" method="post" id="closed-Form">
            ...
            <div id="closed-FormDiv"  class="w-60 m-10">
                <div id="ansDiv0" class="w-[17rem] mb-[1rem]">
                    <label for="answer0" id = "ansLab0" class="flex mb-2 text-sm font-medium text-gray-900 dark:text-white">Answer 1: </label>
        ...
        <div class="ml-10">
            <button onclick="addAnswer()" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Add answer</button>
            <button type="submit" form="closed-Form" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Submit</button>
        </div>        
    </div>
