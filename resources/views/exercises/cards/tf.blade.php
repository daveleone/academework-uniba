<div
    class="m-2.5 w-[35rem] rounded-lg border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800"
>
    ...
    >
        <div class="grid grid-cols-2 gap-2 w-[50rem]">
            @foreach($exercise->elements()->orderBy("position")->get() as $element)
                    ...
                    @else
                        <x-heroicon-s-x-circle class="w-7 h-7 text-red-600"/>
                    @endif
            @endforeach
        </div>
    </ol>
