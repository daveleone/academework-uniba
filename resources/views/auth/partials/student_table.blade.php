<table class="table-auto w-full bg-white dark:bg-gray-700 shadow-lg mb-4 rounded-md border-separate" id="userList">
    <thead>
        <tr class="bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-white">
            <th class="px-4 py-2 text-left">@lang('trad.ID')</th>
            <th class="px-4 py-2 text-left">@lang('trad.Name')</th>
            <th class="px-4 py-2 text-left">@lang('trad.E-mail')</th>
            <th class="px-4 py-2 text-left">@lang('trad.Add Student')</th>
        </tr>
    </thead>
