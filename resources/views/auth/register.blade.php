<x-guest-layout>
    ...
    <form id="student-form" method="POST" action="{{ route('register') }}">
        @csrf
        <input type="hidden" name="form_id" value="student-form">
    ...
    <form id="teacher-form" method="POST" action="{{ route('register') }}" style="display:none;">
        @csrf
        <input type="hidden" name="form_id" value="teacher-form">
