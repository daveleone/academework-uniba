<div {{ $id }} class="m-2.5 w-72 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div class="flex flex-row justify-between">
        <a href="{{ $href }}">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">@lang('' . $name)</h5>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">@lang('' . $description)</p>
        </a>
        ...
        <div class="{{ $displayExFoot}}">
            <p class="mb-2 text-sm tracking-tight text-gray-900 dark:text-white">@lang('trad.' . $type) <br> @lang('trad.' . $points) @lang('trad.points')</p>
        </div>
    </div>
</div>
